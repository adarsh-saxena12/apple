        ...
        <section className="common-padding">
           <div className="sceen-max-width">
                ...
                <div className="mt-10 md:mt-20 mb-14 flex flex-col items-center">
                   <div className="relative h-full flex-center lg:w-[70%]">
                   ...
                   <div className='hiw-text-container'>
                         <div className='flex  flex-1 justify-center flex-col max-w-[600px]'>
                       ...
                       <div className="flex-1 flex justify-center flex-col g_fadeIn max-w-[500px]">
